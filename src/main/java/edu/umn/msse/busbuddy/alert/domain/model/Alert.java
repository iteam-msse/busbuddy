 ...
 * {@link RecurringAlert} extends this Alert Model. Alert can only be created from {@link AlertFactory} and then
...
public class Alert implements Serializable {
	...
	/**
	 * current status of the alert. The value depends upon {@link AlertStatus} enum.
	 */
	...
	/**
	 * Notification type of alert. Depends upon the value as specified in {@link AlertNotificationType}
	 */
	private AlertNotificationType alertType;

	/**
	 * Run type of alert e.g., one time or recurring. Value is defined by {@link AlertRunType}
	 */
	private AlertRunType alertRunType;

	/**
	 * Module that initiated or created this alert. {@link AlertInitiator}
	 */
